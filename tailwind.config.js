  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        glow: "0 0 20px rgba(0, 122, 204, 0.5)",
        "glow-lg": "0 0 40px rgba(0, 122, 204, 0.6)",
      },
      keyframes: {
        "accordion-down": {
          from: { height: "0" },
        ...
        "pulse-glow": {
          "0%, 100%": { boxShadow: "0 0 20px rgba(0, 122, 204, 0.5)" },
          "50%": { boxShadow: "0 0 40px rgba(0, 122, 204, 0.8)" },
        },
      },
      animation: {
